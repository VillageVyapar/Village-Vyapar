                        ...
                        <div class="card mt-3">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">https://Villagevyapar.com</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <span class="text-secondary">village_vyapar</span>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">@Village123</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <input type="text" class="form-control" value="{{$h->a_name}}"
                                                name="fullname" id="fullname" disabled required>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <input type="text" class="form-control" value="{{$h->a_phone}}"
                                                name="phoneno" id="phoneno" disabled required>
