...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul style='positio' class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <div>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="dropdown-item" href="#">
					        <center><img class="img-profile rounded-circle" src="Admin_img/{{$r->a_img}}" height="50px" width="50px" ></center>
				      </a>
              <center><p style='color:Red;font-size:15px;'>{{$r->a_name}}</p></center>
