                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  ...
                  <div style='border:1px solid grey; padding:22px;'>
                    ...
                    <p class="aa-prod-category">
                      ...
                      <p class="aa-prod-category">
                        <b>Category:</b>  {{$p['cat_name']}}</p>
                      </p>
                      <p class="aa-prod-category">
                        <b>Subcategory:</b>  {{$p['subcat_name']}}</p>
                      </p>
                      <p class="aa-prod-category">
                        <b>Description : </b>  {{$p['p_desc']}}</p>
                    </p>
                  </div> 
          ...
          @endforeach
                     ...
                     <li>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" src="/customer_img/{{$fb['c_img']}}" alt="girl image">
                            </a>
                          </div>
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                @foreach($allproduct as $ap)
                  ...
                  @if($ap['subcat_id'] == $p['subcat_id'])
                    <li>
                      <figure>
                      <a  href=""><img style='width:270px;height:300px;' src="/product_images/{{$ap['img']}}"></a>
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                        <figcaption>
                      <h4 class="aa-product-title"><a href="#" style='float:left;padding-left:15px;'><b>{{$ap['p_name']}}</b></a></h4>
                      <span class="aa-product-price" style='float:right;padding-right:15px;'>{{"gram"}} | &#8377; {{$ap['p_price']}}</span><span class="aa-product-price"></span>
                      
                      <h4 class="aa-product-title"><a  style='float:left;padding-left:15px;'><b>{{$ap['c_name']}}</b></a></h4>
                      ...
                      <div class="aa-product-hvr-content">
                        ...
                        <a href="#" data-toggle2="tooltip" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal-{{$ap['p_id']}}"><span class="fa fa-search"></span></a>                            
                      </div>
                      <!-- product badge -->
              ...
              @foreach($allproduct as $ap)
                  @foreach($products as $p)
                    @if($ap['subcat_id'] == $p['subcat_id'])  
                  <div class="modal fade" id="quick-view-modal-{{$ap['p_id']}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <div class="row">
                            ...
                            <div class="simpleLens-gallery-container" id="demo-1">
                              <div class="simpleLens-container">
                                  <div class="simpleLens-big-image-container">
                                      <br>
                                          <img src="/product_images/{{$p['img']}}" style='width:220px;height:300px;' alt="{{$p['p_name']}}"  class="simpleLens-big-image">
                                  </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="aa-product-view-content">
                            <h2>{{$p['p_name']}}</h2>
                            <div class="aa-price-block">
                              <span class="aa-product-view-price"><b>Price (&#8377;) :  </b>{{$p['p_price']}} &#8377;</span>
                              <p ><b>Avilability : </b>
                              @if($p['QOH']>0)
                                  In Stock ({{$p['QOH']}})
                              @else
