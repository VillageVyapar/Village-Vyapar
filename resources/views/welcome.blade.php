                        ...
                        @if($p['cat_id']==1 && $p['subcat_id']==1)
                            ...
                            <figure>
                              ...
                              <figcaption>
                                ...
                                <span class="aa-product-price" style='float:right;padding-right:15px;'>{{"gram"}} | &#8377; {{$p['p_price']}}</span><span class="aa-product-price"></span>
                            ...
                            <div class="aa-product-hvr-content">
                              <a href="url('wishlist')" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
