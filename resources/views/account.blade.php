            ...
            <div class="row">
                 ...
                 <form action="" method="post" class="aa-login-form">
                  ...
                  <label for="">Email address<span>*</span></label>
                   ...
                   <label for="">Password<span>*</span></label>
                    ...
                    <input type="number" style='float:left;width:150px;font-size:25px' name="capcha" readonly value='{{$random}}'/>
                    <input type="number" required style='float:;width:150px;margin-left:50px;font-size:25px;' name="cuscapcha"/><br><br>
                    <button type="submit" class="aa-browse-btn">Login</button>
                    <!-- <label class="rememberme" for="rememberme"><input type="checkbox" id="rememberme"> Remember me </label> -->
                    <p class="aa-lost-password"><a  style='cursor:pointer;color:blue;padding-left:30px;' onClick='forgotpass()'><b>Lost your password ?</b></a></p>
                  </form ><br><br><br>
                  ...
                  <label for="">Email address<span>*</span></label>
                   <input type="email" name='email' required placeholder="Enter Email Id">
                    ...
                    <!-- <label class="rememberme" for="rememberme"><input type="checkbox" id="rememberme"> Remember me </label> -->
                    <b>Note : </b><p> Password will be send in email id and if you want to reset your password then also send link of change password link !!</p>
                  </form>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form action="reg" enctype="multipart/form-data" method='post' class="aa-login-form" id="regForm">
                    {{@csrf_field()}}
