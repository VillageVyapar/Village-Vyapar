...
if (_isNS('google.translate.Element')){return}(function(){var c=_setupNS('google.translate._const');c._cest = gtConstEvalStartTime;gtConstEvalStartTime = undefined;c._cl='en';c._cuc='googleTranslateElementInit';c._cac='';c._cam='';c._ctkk='450850.4126341684';var h='translate.googleapis.com';var s=(true?'https':window.location.protocol=='https:'?'https':'http')+'://';var b=s+h;c._pah=h;c._pas=s;c._pbi=b+'/translate_static/img/te_bk.gif';c._pci=b+'/translate_static/img/te_ctrl3.gif';c._pli=b+'/translate_static/img/loading.gif';c._plla=h+'/translate_a/l';c._pmi=b+'/translate_static/img/mini_google.png';c._ps=b+'/translate_static/css/translateelement.css';c._puh='translate.google.com';_loadCss(c._ps);_loadJs(b+'/translate_static/js/element/main.js');})();})();
          ...
          <div class="col-md-12">
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
				...
				<div class="cellphone hidden-xs">
                   &nbsp;&nbsp;Select Language :&nbsp;&nbsp; 
						<div style='float:right' id="google_translate_element"></div>   <!---   Google translate id  ---->
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
                ...
                {{ @csrf_field() }}
                  <input type="text" name="search" required  id="" placeholder="Search here all village products ..">
