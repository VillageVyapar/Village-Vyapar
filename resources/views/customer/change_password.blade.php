                                ...
                                <div class="panel-body">
                                    ...
                                    {{@csrf_field()}}
                                                <div class="form-group">
                                                    ...
                                                    <input type='password' name='currentp' class='form-input' required  placeholder='Enter Current Password here'>
                                                </div>
                                                <div class="form-group">
                                                    <label>New Password : </label>
                                                    <input type='password'class="form-input" name='newp' required placeholder='Enter New Password here'>
                                                </div>
                                                <div class="form-group">
                                                    <label>Confirm Password : </label>
                                                    <input type='password' class="form-input" name='newcp' required placeholder='Enter Confirm Password here'>
                                                </div>
                                                <a href="url('change_pass')"><input type='submit' class="btn btn-success" value='Change'/></a> &nbsp;&nbsp;&nbsp;
