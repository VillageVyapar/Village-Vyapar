                ...
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                        ...
                        <!-- /.col-lg-8 -->
                            ...
                            <canvas id="bar" style="border:1px solid grey;padding:25px;float:left;height:500px;width:100%;max-width:800px;"></canvas>
                            <canvas id="pie" style="border:1px solid grey;padding:25px;float:left;margin-top:25px;width:100%;max-width:500px"></canvas><!-- /.panel-body -->
