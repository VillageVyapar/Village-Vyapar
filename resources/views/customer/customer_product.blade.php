                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            {{-- <a href='{{ url('',$pc['p_id']) }}'><button type="button"
                                                ...
                                                <a data-toggle="modal" data-target="#editproduct{{$pc->p_id}}"><button
                                                        type="button" class="btn btn-sucess">Edit</button></a><br><br>
                                                <a href="{{ url('del_product',$pc['p_id']) }}"><button type="button"
                                                        class="btn btn-danger">Delete</button></a>
                                        </td>
                                        <div class="modal fade" id="editproduct{{$pc->p_id}}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title" id="exampleModalLabel">{{$pc->p_name}}
                                                            Edit
                                                            <button class="close" type="button" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <input class="z" type="submit"
                                                                    style='border:none;float:right;' value="X" />
                                                            </button>
                                                        </h3>
                                                    </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="qoh"
                                                                    placeholder="Enter Quantity at hand" required
                                                                    value="{{$pc->QOH}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="image">Product Image</label>
                                                                <img src="product_images/{{$pc['img']}}" height='100' width='130' alt="{{$pc->p_name}}" srcset="">
                                                                <input type="file" class="form-control" name="img"
                                                                    placeholder="Upload Image"
                                                                    requiredvalue="{{$pc->img}}">
                                                            </div>
                                                        </div>
