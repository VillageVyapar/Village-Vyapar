        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              ...
              <!-- quick view modal -->     
              @foreach($products as $p)             
              <div class="modal fade" id="quick-view-modal-{{$p['p_id']}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-sidebar-price-range">
               ...
               <input type='range' value=0 id='rangevalue' style='width:250px;height:10px'; onchange="getMessage(this.value)" step=20 min='{{$minprice}}' max="{{$maxprice}}"  value='0'/>
               
						<br><span style='color:red;font-size:18px;'>Selected Price(&#8377;) :</span><input type="text" style="width:50px;background-color:white; border:none;" id="div2" value=0 disabled />
               </form>
              </div>              
            </div>
            <br> <br>
