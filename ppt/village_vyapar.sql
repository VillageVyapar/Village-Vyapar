...
(1, 'Jhon Dorsan', 'zeelchauhan123@gmail.com', 'zeel1234', 8460730642, '1626875647_shyam.jpg');
...
(17, 1, 2, 'Hello seller', '2021-07-23 08:50:08', 1),
(18, 2, 1, 'Hello seller', '2021-07-27 08:40:54', 1),
(19, 2, 1, 'hii', '2021-07-31 06:46:44', 1);
...
(1, 'Ram C', 'ram123@gmail.com', 'eyJpdiI6InkrYllOMWFWYi9DbGpxb245c252MGc9PSIsInZhbHVlIjoiT1hpaHNtS3JoTWZ1OEpNUWs5K2REdz09IiwibWFjIjoiZmE3NzlmMjcyZDY5NTJiM2IyZTNjZWU5ZmRlYWNkMWRiYzQ1ZTU3OGQyZWMwMDM4ZDhkZTgzMWM2YzFjZTZkYiJ9', 8460730568, 'simple.png', 'bapunagar', 'chandkheda', 'ahmedabad', 382424),
(2, 'zeel chauhan', 'zeelchauhan123@gmail.com', 'eyJpdiI6InkrYllOMWFWYi9DbGpxb245c252MGc9PSIsInZhbHVlIjoiT1hpaHNtS3JoTWZ1OEpNUWs5K2REdz09IiwibWFjIjoiZmE3NzlmMjcyZDY5NTJiM2IyZTNjZWU5ZmRlYWNkMWRiYzQ1ZTU3OGQyZWMwMDM4ZDhkZTgzMWM2YzFjZTZkYiJ9', 9662892726, 'simple.png', 'Gheekanta', 'sola gam', 'ahmedaabd', 380003),
...
(1, 'ram', 'zeelchauhan123@gmail.com', 'Add Category', 'TCS', 'i want to add my old mobile phone in your website so can I ????\r\n', 'ok i will let you know as soon as possible', 1),
(3, 'rahul', 'rahul123@yahoo.com', 'product', 'Tata products', 'i want to sell my old products but category are different', 'no it is not available for old product !!!', 1);
...
(1, 'Lemon pickle', 200, 'The sourness of the lemon spreading throughout the mouth is something you want to have with the sweet curds and white rice. It gives an immense tummy filling satisfaction by the end of the plate! And if you are a \"sour food liking\" person, lime pickles are totally your type of dishes.', '2021-05-21', 10, 'Lemon_pickle.jpg', 1, 1, 1, 4, 66),
(2, 'Carrot pickle', 300, 'Pickle usually gives the idea of spicy side dish along with the main courses. Since carrot is usually sweet or not-so-sweet vegetable, the specialty of carrot pickle lies in the making of it.', '2021-04-01', 10, 'Carrot pickle.jpg', 1, 1, 2, 4, 9),
(3, 'Onion pickle', 250, 'This one is mostly made on a daily basis in the Indian kitchens. Usually, good going along with the main dish normally serves as a salad. The bitter taste of onions along with sourness of lemon, spice of chili powder is a treat to your taste buds.', '2021-04-10', 5, 'Onion pickle.jpg', 1, 1, 2, 0, 3),
(4, 'Garlic pickle', 170, 'Scientifically talking, garlic have good medicinal properties because of a compound called allicin present in them. And garlic pickles have been one of the oldest in times. No wonder our ancestors were very healthy and strong.', '2021-05-14', 15, 'Garlic pickle.jpg', 1, 1, 1, 0, 36),
(5, 'Green chilli pickle', 100, 'Definitely hot and spicy, green chili pickles are a feast to the ones who love spicy food items. They are mostly had along with plain rice or usually with plain blend parathas.', '2021-02-04', 12, 'Green chilli pickle.jpg', 1, 1, 2, 0, 11),
(6, 'Tuna Fish Pickle', 150, 'Tuna Fish Pickle', '2021-05-04', 15, 'Tuna Fish Pickle.jpg', 1, 2, 1, 0, 26),
(7, 'Prawns Pickle', 450, 'Prawns Pickle', '2021-05-15', 15, 'Prawns Pickle.jpg', 1, 2, 2, 0, 2),
...
(24, 'Tamflex-SP', 1000, 'Tamflex-SP Flunixin Meglumine and Serratiopeptidase Bolus, Timru Pharmaceuticals', '2021-02-09', 2, 'Tamflex-SP.jpeg', 2, 6, 1, 1, 4),
...
(29, 'Jeevamrut', 190, 'Jeevamrut is a liquid organic manure popularly used as means of organic gardening. It is considered to be an excellent source of natural carbon, biomass, nitrogen, phosphorous potassium and lot of other micro nutrients required for the plants.', '2021-03-14', 75, 'Jeevamrut.jpg', 2, 7, 1, 0, 1),
...
(43, 'Imported Canary Seed', 90, 'Imported Canary Seed for All Birds (450 Grams)', '2021-05-11', 15, 'Imported Canary Seed.jpg', 4, 11, 1, 0, 1),
...
(45, 'VeggieDrop', 600, 'Plantic VeggieDrop Micronutrients Liquid Fertilizer For Vegetables (Best Organic Fertilizer For Vegetable Plants) - 250 ml', '2021-02-26', 6, 'VeggieDrop.jpg', 5, 12, 7, 0, 2),
...
--
ALTER TABLE `inquiries`
  MODIFY `i_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `products`
  MODIFY `p_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
